...
function SteamAvatars:__init()
    ...
    self.request_url = string.format("http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=%s&steamids=", GetConvar("steam_webApiKey", ""))
...
--[[
Just in case you want more data lul
{
    "response":
        {"players":
        [
